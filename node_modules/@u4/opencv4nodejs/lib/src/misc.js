...
function default_1(cv) {
     ...
     */
    cv.toMatTypeName = function toMatTypeName(type) {
     ...
     */
    cv.getScoreMax = function getScoreMax(scoreMat, threshold, region) {
     ...
     */
    cv.dropOverlappingZone = function dropOverlappingZone(template, matches) {
